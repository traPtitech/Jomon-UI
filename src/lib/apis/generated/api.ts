 ...
 * @export
 */
export const AdminsApiAxiosParamCreator = function (
...
export const AdminsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteAdmins(
        requestBody,
        options
      )
    ...
    async postAdmins(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.postAdmins(
        requestBody,
        options
      )
      return createRequestFunction(
...
export const AdminsApiFactory = function (
  ...
  return {
    ...
    deleteAdmins(
      ...
      return localVarFp
        .deleteAdmins(requestBody, options)
    ...
    postAdmins(requestBody: Array<string>, options?: any): AxiosPromise<void> {
      return localVarFp
        .postAdmins(requestBody, options)
        .then(request => request(axios, basePath))
    }
  }
}
...
export const AuthApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.generatePKCE(options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const FilesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getFileMeta(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<FileMeta>
    > {
...
export const FilesApiFactory = function (
  ...
  return {
    ...
    postFile(
      ...
      return localVarFp
        .postFile(file, name, requestId, options)
        .then(request => request(axios, basePath))
    }
  }
}
...
export const GroupsApiAxiosParamCreator = function (
  ...
  return {
    ...
    deleteGroupOwners: async (
      ...
      const localVarPath = `/groups/{groupID}/owners`.replace(
        `{${'groupID'}}`,
        encodeURIComponent(String(groupID))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const GroupsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteGroupMembers(
          groupID,
          requestBody,
          options
        )
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.deleteGroupOwners(
          groupID,
          requestBody,
          options
        )
    ...
    async getGroupDetail(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GroupDetail>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getGroupDetail(
        groupID,
        options
      )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.postGroup(
        postGroup,
        options
      )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.postGroupMembers(
          groupID,
          requestBody,
          options
        )
    ...
    async postGroupOwners(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<string>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.postGroupOwners(
        groupID,
        requestBody,
        options
      )
    ...
    async putGroupDetail(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Group>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.putGroupDetail(
        groupID,
        putGroup,
        options
      )
...
export const GroupsApiFactory = function (
  ...
  return {
    ...
    deleteGroupMembers(
      ...
      return localVarFp
        .deleteGroupMembers(groupID, requestBody, options)
        .then(request => request(axios, basePath))
    },
    /**
     * ユーザーをグループから削除する。管理者権限またはグループオーナー権限が必要。
    ...
    deleteGroupOwners(
      ...
      return localVarFp
        .deleteGroupOwners(groupID, requestBody, options)
        .then(request => request(axios, basePath))
    },
    /**
     * グループの情報を返す。
    ...
    getGroupDetail(groupID: string, options?: any): AxiosPromise<GroupDetail> {
      return localVarFp
        .getGroupDetail(groupID, options)
        .then(request => request(axios, basePath))
    },
    /**
     * グループの一覧を返す。
    ...
    postGroupMembers(
      ...
      return localVarFp
        .postGroupMembers(groupID, requestBody, options)
        .then(request => request(axios, basePath))
    },
    /**
     * グループオーナーをグループに追加する。管理者権限またはグループオーナー権限が必要。
    ...
    postGroupOwners(
      ...
      return localVarFp
        .postGroupOwners(groupID, requestBody, options)
        .then(request => request(axios, basePath))
    },
    /**
     * グループの情報を変更する。管理者権限またはグループオーナー権限が必要。
    ...
    putGroupDetail(
      ...
      return localVarFp
        .putGroupDetail(groupID, putGroup, options)
        .then(request => request(axios, basePath))
    }
  }
}
...
export const RequestsApiAxiosParamCreator = function (
  ...
  return {
    ...
    getRequestDetail: async (
      ...
      const localVarPath = `/requests/{requestID}`.replace(
        `{${'requestID'}}`,
    ...
    postComment: async (
      ...
      const localVarPath = `/requests/{requestID}/comments`.replace(
        `{${'requestID'}}`,
        encodeURIComponent(String(requestID))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    putStatus: async (
      ...
      const localVarPath = `/requests/{requestID}/status`.replace(
        `{${'requestID'}}`,
        encodeURIComponent(String(requestID))
      )
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const RequestsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getRequestDetail(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RequestDetail>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getRequestDetail(requestID, options)
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async getRequests(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Request>>
    > {
    ...
    async postRequest(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<RequestDetail>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.postRequest(
        postRequest,
        options
      )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.putRequestDetail(
          requestID,
          postRequest,
          options
        )
    ...
    async putStatus(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<StatusDetail>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.putStatus(
        requestID,
        putStatus,
        options
      )
...
export const RequestsApiFactory = function (
  ...
  return {
    ...
    getRequestDetail(
      requestID: string,
      options?: any
    ): AxiosPromise<RequestDetail> {
      return localVarFp
        .getRequestDetail(requestID, options)
        .then(request => request(axios, basePath))
    },
    /**
     * 依頼一覧を取得する。
    ...
    postComment(
      ...
      return localVarFp
        .postComment(requestID, postComment, options)
        .then(request => request(axios, basePath))
    },
    /**
     * 依頼を新規作成する。
    ...
    postRequest(
      ...
      return localVarFp
        .postRequest(postRequest, options)
        .then(request => request(axios, basePath))
    },
    /**
     * 指定した依頼を修正する。作成者権限が必要。
    ...
    putRequestDetail(
      ...
      return localVarFp
        .putRequestDetail(requestID, postRequest, options)
        .then(request => request(axios, basePath))
    },
    /**
     * 指定した依頼のstatusを変更のみ(新規はpost /requests)する。commentは常に必須(ないときは空文字列)。statusの行き来の定義は作成者は「fix_requiredからsubmitted」をでき、adminは「submittedからrejected」「submittedからrequired」「fix_requiredからsubmitted」「submittedからaccepted」「acceptedからsubmitted（ただしすでに支払われている人がいた場合、この操作は不可)」の操作のみ可。ただし、「acceptedからfully_repaid」の操作はここでは行えない。管理者権限または作成者権限が必要。
    ...
    putStatus(
      ...
      putStatus: PutStatus,
      options?: any
    ): AxiosPromise<StatusDetail> {
      return localVarFp
        .putStatus(requestID, putStatus, options)
        .then(request => request(axios, basePath))
    }
  }
}
...
export const TagsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async tagsTagIDDelete(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.tagsTagIDDelete(
        tagID,
        options
      )
      return createRequestFunction(
    ...
    async tagsTagIDGet(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Tag & object>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.tagsTagIDGet(
        tagID,
        options
      )
      return createRequestFunction(
...
export const TransactionsApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    putTransactionDetail: async (
      transactionID: string,
      postTransactionWithOneTarget: PostTransactionWithOneTarget,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'transactionID' is not null or undefined
...
export const TransactionsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getTransactionDetail(
          transactionID,
          options
        )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.postTransaction(
        postTransaction,
        options
      )
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.putTransactionDetail(
          transactionID,
          postTransactionWithOneTarget,
          options
        )
...
export const TransactionsApiFactory = function (
  ...
  return {
    ...
    postTransaction(
      ...
      return localVarFp
        .postTransaction(postTransaction, options)
        .then(request => request(axios, basePath))
    },
    /**
     * 指定したTransactionを修正する。管理者権限が必要。requestに紐づいている場合は変更不可。
