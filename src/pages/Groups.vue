...
<template>
  <div>
    ...
    <div :class="pageIndex === Math.ceil(groupsLength() / 10) ? 'h-138' : ''">
      <div class="w-3/5 mr-auto ml-auto border-solid border-black border-2">
        <div class="flex justify-around items-center bg-gray-200 pt-2 pb-2">
          <div class="flex-1 text-center">グループ名</div>
          <div class="flex-1 text-center">管理者</div>
          <div class="flex-1 text-center">詳細</div>
          <div class="flex-1 text-center">予算</div>
        </div>
        <div
